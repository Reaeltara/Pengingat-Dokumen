    ...
    <div class="glass w-100" style="max-width: 420px; border-radius: 24px; box-shadow: 0 20px 60px rgba(0,0,0,.08); padding: 2rem;">
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <div>
                ...
                <p class="text-secondary small mb-0">Buat akun baru</p>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('register.store') }}" class="d-grid gap-3">
            ...
            <div>
                ...
                <input type="text" id="phone" name="phone" value="{{ old('phone') }}" required
                       class="form-control form-control-lg" placeholder="Contoh: 62812xxxxxxx">
                <div class="form-text">Gunakan format 62, tanpa tanda + atau spasi.</div>
            </div>
