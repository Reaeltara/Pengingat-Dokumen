...
<head>
    ...
    <title>DoCExpire - Tambah Dokumen</title>
    ...
    <style>
        ...
        .page-shell {
            background: radial-gradient(circle at top left, #f2eaff 0%, #ffffff 48%, #f6f1ff 100%);
            min-height: 100vh;
...
<div class="page-shell">
    <div class="container">
        <div class="form-card">
            <div class="mb-4">
                <h1 class="section-title">Tambah Dokumen</h1>
                <p class="text-secondary mb-0">Lengkapi detail dokumen agar masa berlakunya terpantau.</p>
            </div>
            ...
            <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data">
                ...
                @php
                    ...
                    $selectedDocument = old('nama_dokumen');
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <select name="nama_dokumen" id="nama_dokumen" class="form-select">
                            ...
                            <option value="{{ $manualOptionValue }}"
                                ...
                                @selected($selectedDocument === $manualOptionValue)
                            >
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-text">Format file harus PDF, maksimal 10 MB.</div>
                    </div>
                </div>
